...
import { ref, shallowRef } from 'vue'
    ...
    try{
      let d = await axios.get('https://api.themoviedb.org/3/movie/'+id+'/alternative_titles?api_key=0b5e8ce7494ae54d6c643adf4db40da7')
      otherData.value = await d.data.titles
