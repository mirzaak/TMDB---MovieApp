  ...
  <div class="pageWrapper">
    ...
    <div class="right" >
        <div class="backdrops">
           ...
           <div class="logoImg"> <img :src=" slika + backdrop.file_path" alt="" @click="openImage(backdrop.file_path)"></div>
            <div class="imgInfo">
                <a>Info</a>
            </div>
            <p>Language</p>
...
setup(){
    ...
    try{
      let d = await axios.get('https://api.themoviedb.org/3/movie/'+id+'/images?api_key=0b5e8ce7494ae54d6c643adf4db40da7')
      otherData.value = await d.data.logos
    ...
    try{
      let d = await axios.get('https://api.themoviedb.org/3/movie/'+id+'/images?api_key=0b5e8ce7494ae54d6c643adf4db40da7')
      clipdata.value = await d.data.logos
...
.logoImg img{
    cursor: pointer;
    background-image: url(../../assets/backgroundBlank.png);
    padding: 40px;
    width: 100%;
