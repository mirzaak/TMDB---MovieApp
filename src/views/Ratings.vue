...
<div class="header">
        ...
        <span><router-link  class="discc overview" :to="{ name: 'Ratings', params: { id: id }}">Ratings</router-link></span>
        <span><router-link class="discc" :to="{ name: 'Watchlist', params: { id: id }}">Watchlist</router-link></span>
...
import { useUserStore } from "../stores/user.js";
    ...
    try{
      let movieData = await axios.get('https://api.themoviedb.org/3/account/{account_id}/rated/movies?api_key=0b5e8ce7494ae54d6c643adf4db40da7&language=en-US&session_id='+store.sesija+'&sort_by='+filterTip.value+'&page=1')
      let tvData = await axios.get('https://api.themoviedb.org/3/account/{account_id}/rated/tv?api_key=0b5e8ce7494ae54d6c643adf4db40da7&language=en-US&session_id='+store.sesija+'&sort_by='+filterTip.value+'&page=1')
...
otherData.value[i].rating = 0
    ...
    const changeType = async(type) => {
      tip.value = type
      let movieData = await axios.get('https://api.themoviedb.org/3/account/{account_id}/rated/'+type+'?api_key=0b5e8ce7494ae54d6c643adf4db40da7&language=en-US&session_id='+store.sesija+'&sort_by=created_at.'+filterTip.value+'&page=1')
        otherData.value = await movieData.data.results
        if(tip.value =='tv'){
            tvData.value = true
        }else{
...
if(tip.value == 'movies'){
 await axios.delete('https://api.themoviedb.org/3/movie/'+id+'/rating?api_key=0b5e8ce7494ae54d6c643adf4db40da7&session_id='+store.sesija)
let movieData = await axios.get('https://api.themoviedb.org/3/account/{account_id}/rated/movies?api_key=0b5e8ce7494ae54d6c643adf4db40da7&language=en-US&session_id='+store.sesija+'&sort_by='+filterTip.value+'&page=1')
otherData.value = movieData.data.results

}else if( tip.value == 'tv'){
 await axios.delete('https://api.themoviedb.org/3/tv/'+id+'/rating?api_key=0b5e8ce7494ae54d6c643adf4db40da7&session_id='+store.sesija)
let movieData = await axios.get('https://api.themoviedb.org/3/account/{account_id}/rated/tv?api_key=0b5e8ce7494ae54d6c643adf4db40da7&language=en-US&session_id='+store.sesija+'&sort_by='+filterTip.value+'&page=1')
otherData.value = movieData.data.results
...
$(document).mouseup(function(e) 
{
    ...
    const filter = async(filterType) => {
        ...
        if(tip.value == 'movies'){
      let movieData = await axios.get('https://api.themoviedb.org/3/account/{account_id}/rated/movies?api_key=0b5e8ce7494ae54d6c643adf4db40da7&language=en-US&session_id='+store.sesija+'&sort_by='+filterType+'&page=1')
        otherData.value = movieData.data.results
        }else if(tip.value == 'tv'){
      let movieData = await axios.get('https://api.themoviedb.org/3/account/{account_id}/rated/tv?api_key=0b5e8ce7494ae54d6c643adf4db40da7&language=en-US&session_id='+store.sesija+'&sort_by='+filterType+'&page=1')
        otherData.value = movieData.data.results
        }
