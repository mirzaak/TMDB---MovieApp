        ...
        <div class="movie"  v-for="(movie) in popular.results" :key="movie">
            ...
            <div class="moreback" >
                ...
                <div class="card">
                    ...
                    <p class="pDate">{{movie.first_air_date}}</p>
                </div>
            </div>
...
const store = useDataStore();
  ...
  const loadData = async() => {
    try{
      let popularData = await axios.get('https://api.themoviedb.org/3/tv/airing_today?api_key=0b5e8ce7494ae54d6c643adf4db40da7&language=en-US&page=1')
    ...
    const loadOtherData = async() => {
      ...
      let movieData = await axios.get('https://api.themoviedb.org/3/account/{account_id}/watchlist/tv?api_key=0b5e8ce7494ae54d6c643adf4db40da7&language=en-US&session_id='+storeUser.sesija+'&page=1')
      ...
      let favMoviesData = await axios.get('https://api.themoviedb.org/3/account/{account_id}/favorite/tv?api_key=0b5e8ce7494ae54d6c643adf4db40da7&session_id='+storeUser.sesija+'&language=en-US&page=1')
      ...
      let rMovies = await axios.get('https://api.themoviedb.org/3/account/{account_id}/rated/tv?api_key=0b5e8ce7494ae54d6c643adf4db40da7&language=en-US&session_id='+storeUser.sesija+'&page=1')
...
otherData.value[i].rating = 0
  ...
  const loadMore = async() => {
    try{
      ...
      let moreData = await axios.get('https://api.themoviedb.org/3/tv/airing_today?api_key=0b5e8ce7494ae54d6c643adf4db40da7&language=en-US&page='+number++)
...
for(let i = 0 ; ratedMovies.value.length > i ;i++){
 ...
 await axios.post('https://api.themoviedb.org/3/tv/'+movie.id+'/rating?api_key=0b5e8ce7494ae54d6c643adf4db40da7&session_id='+storeUser.sesija, {
  "value": movie.rating,
 ...
 await axios.delete('https://api.themoviedb.org/3/tv/'+movie.id+'/rating?api_key=0b5e8ce7494ae54d6c643adf4db40da7&session_id='+storeUser.sesija,)
    }
